        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div>
                ...
                <div class="flex space-x-4">
                    <a href="https://github.com/saasco" target="_blank" class="hover:text-white transition-colors">
                    ...
                    <a href="https://linkedin.com/company/saasco" target="_blank" class="hover:text-white transition-colors">
